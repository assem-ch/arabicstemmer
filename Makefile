...
ARABIC_BASED_ROOT_STEMMER = "algorithm/based_root_stemmer.sbl"
...
STEMS="test_data/test_golden_corpus/stems_output.txt"
ROOTS="test_data/test_golden_corpus/roots_output.txt"
